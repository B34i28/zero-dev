...
exports.getPaymasterAddress = exports.getPrivateKeyByToken = exports.getProjectsConfiguration = exports.getChainId = exports.signUserOp = void 0;
const constants = __importStar(require("./constants"));
const signUserOp = async (projectId, chainId, userOp, entryPointAddress, paymasterUrl, callData, gasTokenAddress, erc20UserOp, erc20CallData) => {
    try {
...
const getProjectsConfiguration = async (projectIds, backendUrl) => {
    ...
    if (projectConfigurationCache[projectIdsKey] === undefined) {
        projectConfigurationCache[projectIdsKey] = new Promise((resolve, reject) => {
            fetch(`${backendUrl !== null && backendUrl !== void 0 ? backendUrl : constants.BACKEND_URL}/v1/projects/get`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
...
exports.getProjectsConfiguration = getProjectsConfiguration;
...
const getPaymasterAddress = async (chainId, entryPointAddress, paymasterUrl) => {
    try {
        const resp = await fetch(`${paymasterUrl !== null && paymasterUrl !== void 0 ? paymasterUrl : constants.PAYMASTER_URL}/getPaymasterAddress`, {
            method: 'POST',
            body: JSON.stringify({
                chainId,
                entryPointAddress
