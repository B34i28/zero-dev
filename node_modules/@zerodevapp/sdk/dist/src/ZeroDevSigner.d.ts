...
export declare class ZeroDevSigner extends Signer {
    ...
    address?: string;
    sendTransaction(transaction: Deferrable<TransactionRequest>, executeBatchType?: ExecuteType): Promise<TransactionResponse>;
    ...
    getExecBatchTransaction(calls: Array<Call>, options?: ExecArgs): Promise<Deferrable<TransactionRequest>>;
    execBatch(calls: Array<Call>, options?: ExecArgs): Promise<ContractTransaction>;
