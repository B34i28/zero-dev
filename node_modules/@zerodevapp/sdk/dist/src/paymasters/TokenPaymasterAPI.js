...
class TokenPaymasterAPI extends PaymasterAPI_1.PaymasterAPI {
    constructor(projectId, paymasterUrl, chainId, entryPointAddress, gasTokenAddress, paymasterAddress) {
        super();
    ...
    async getPaymasterResp(userOp, erc20UserOp) {
        ...
        const paymasterResp = await (0, api_1.signUserOp)(this.projectId, this.chainId, hexifiedUserOp, this.entryPointAddress, this.paymasterUrl, resolvedUserOp.callData, this.gasTokenAddress, hexifiedERC20UserOp, resolvedERC20UserOp.callData);
