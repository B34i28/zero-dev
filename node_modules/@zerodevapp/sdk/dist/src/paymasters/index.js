...
async function getPaymaster(projectId, paymasterUrl, chainId, entryPointAddress, gasToken) {
    let gasTokenAddress;
    ...
    if (gasTokenAddress !== undefined) {
        ...
        if (paymasterAddress !== undefined) {
            return new TokenPaymasterAPI_1.TokenPaymasterAPI(projectId, paymasterUrl, chainId, entryPointAddress, gasTokenAddress, paymasterAddress);
        }
    }
    return new VerifyingPaymasterAPI_1.VerifyingPaymasterAPI(projectId, paymasterUrl, chainId, entryPointAddress);
}
