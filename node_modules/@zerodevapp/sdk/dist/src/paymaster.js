...
class VerifyingPaymasterAPI extends PaymasterAPI_1.PaymasterAPI {
    constructor(projectId, paymasterUrl, chainId, entryPointAddress) {
        super();
    ...
    async getPaymasterResp(userOp) {
        ...
        const paymasterResp = await (0, api_1.signUserOp)(this.projectId, this.chainId, hexifiedUserOp, this.entryPointAddress, this.paymasterUrl);
        if (!paymasterResp) {
