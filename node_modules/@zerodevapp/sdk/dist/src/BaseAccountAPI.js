...
class BaseAccountAPI {
    ...
    async getUserOpHash(userOp) {
        ...
        return this.entryPointView.getUserOpHash(Object.assign(Object.assign({}, userOp), { signature: '0x' }));
    }
    /**
    ...
    async createUnsignedUserOp(info, executeType = ExecuteType.EXECUTE) {
        ...
        const partialUserOp = {
            ...
            maxFeePerGas: feeData ? ((_b = (await feeData).maxFeePerGas) !== null && _b !== void 0 ? _b : undefined) : maxFeePerGas,
            maxPriorityFeePerGas: feeData ? ((_c = (await feeData).maxPriorityFeePerGas) !== null && _c !== void 0 ? _c : undefined) : maxPriorityFeePerGas,
        ...
        if (partialUserOp.paymasterAndData === '0x' && this.httpRpcClient !== undefined) {
            try {
                ...
                partialUserOp.preVerificationGas = preVerificationGas !== null && preVerificationGas !== void 0 ? preVerificationGas : partialUserOp.preVerificationGas;
                partialUserOp.verificationGasLimit = verificationGas !== null && verificationGas !== void 0 ? verificationGas : partialUserOp.verificationGasLimit;
                partialUserOp.callGasLimit = callGasLimit !== null && callGasLimit !== void 0 ? callGasLimit : partialUserOp.callGasLimit;
                partialUserOp.callData = (_l = paymasterResp === null || paymasterResp === void 0 ? void 0 : paymasterResp.callData) !== null && _l !== void 0 ? _l : partialUserOp.callData;
            }
            catch (_) { }
        }
    ...
    async getFeeData() {
        ...
        if (block && block.baseFeePerGas) {
            ...
            const minimumTip = ethers_1.BigNumber.from("1500000000");
