...
exports.getProjectsConfiguration = exports.initiateProject = exports.asZeroDevSigner = exports.isZeroDevSigner = exports.getZeroDevSigner = exports.getZeroDevProvider = exports.revokeSessionKey = exports.createSessionKeySigner = exports.createSessionKey = exports.getRPCProviderOwner = exports.getPrivateKeyOwner = exports.ZeroDevProvider = exports.AssetType = exports.ZeroDevSigner = void 0;
...
async function getZeroDevProvider(params) {
    ...
    const providerUrl = (0, utils_1.getRpcUrl)(chainId);
    ...
    const aaProvider = await (0, Provider_1.wrapProvider)(provider, aaConfig, params.owner, { skipFetchSetup: params.skipFetchSetup });
    return aaProvider;
}
